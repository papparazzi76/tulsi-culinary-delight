    ...
    <section id="about" className="py-20 bg-secondary">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div className="relative">
              <img 
                ...
                className="rounded-2xl shadow-tulsi w-full h-auto"
              />
          ...
          {/* Content */}
          <div 
            className={`lg:w-1/2 text-center lg:text-left transition-all duration-1000 delay-300 ${
              isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'
            }`}
          >
            <h2 className="text-5xl md:text-6xl font-bold text-accent mb-8 font-playfair">
              Nuestra Esencia
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
              {features.map((feature, index) => (
                <div 
                  key={index}
                  className={`bg-card border border-border rounded-xl p-6 hover:border-accent/50 transition-all duration-300 hover:shadow-tulsi-card ${
