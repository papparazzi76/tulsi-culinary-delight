  ...
  items: [
    {
      ...
      price: "15.50€",
      allergens: ['gluten', 'lacteos', 'frutos_cascara']
    },
    {
      ...
      items: [
        {
          ...
          price: "10.50€",
          allergens: ['frutos_cascara', 'sulfitos']
        },
        {
          name: "Pulao Rice",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          price: "5.00€",
          allergens: ['gluten', 'lacteos', 'frutos_cascara', 'sulfitos']
        },
        {
          name: "Tandoori Naan",
